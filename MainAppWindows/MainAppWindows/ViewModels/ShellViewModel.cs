...
namespace MainAppWindows.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private SplitViewDisplayMode _displayMode = SplitViewDisplayMode.CompactOverlay; //Default: CompactInline
        ...
        private void GoToState(string stateName)
        {
            switch (stateName)
            {
                case PanoramicStateName:
                    DisplayMode = SplitViewDisplayMode.CompactOverlay; //Default: CompactInline
                    break;
                case WideStateName:
                    DisplayMode = SplitViewDisplayMode.CompactOverlay; //Default: CompactInline
                    IsPaneOpen = false;
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<LejlighedPage>("Shell_Lejlighed".GetLocalized(), Symbol.Street));
            _primaryItems.Add(ShellNavigationItem.FromType<AndelshaverPage>("Shell_Andelshaver".GetLocalized(), Symbol.ContactInfo));

            //_secondaryItems.Add(ShellNavigationItem.FromType<LoginPage>("Shell_Login".GetLocalized(), Symbol.AddFriend));
        }
        ...
        {
            ShellNavigationItem navigationItem = item as ShellNavigationItem;
            if (navigationItem != null)
            {
